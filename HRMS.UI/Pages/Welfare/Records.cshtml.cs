...
namespace HRMS.UI.Pages.Welfare
{
    ...
    public class RecordsModel : BasePageModel
    {
        ...
        public async Task OnGetAsync()
        {
            ...
            TotalApprovedCount = Requests.Count(r => 
            ...
            TotalPendingCount = Requests.Count(r => 
                (r.CurrentStatus == "Pending" || r.Status == "UnderReview" || r.CurrentStatus == "UnderReview") &&
                r.Status != "Approved" && r.CurrentStatus != "PendingPayment" && r.CurrentStatus != "Rejected" && r.Status != "Rejected");
            TotalDisbursedAmount = Requests
                .Where(r => r.Status == "Approved" || r.Status == "Paid" || r.Status == "PaymentCompleted" || r.Status == "Disbursed" ||
                            r.CurrentStatus == "Approved" || r.CurrentStatus == "PendingPayment" || r.CurrentStatus == "PaymentCompleted" ||
                            r.CurrentStatus == "Paid" || r.CurrentStatus == "Disbursed")
