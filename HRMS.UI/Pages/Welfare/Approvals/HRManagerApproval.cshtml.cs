    ...
    public class HRManagerApprovalModel : BasePageModel
    {
        ...
        public async Task OnGetAsync()
        {
            ...
            PendingRequests = await _db.WelfareRequests
                ...
                .Where(r => r.CurrentLevel == "HRManager" && r.CurrentStatus == "Pending" && r.Employee != null && !r.Employee.NIC.StartsWith("DUTY") && r.Employee.NIC != "DUTY-ACC")
            ...
            if (user != null)
            {
                ...
                if (employee != null)
                {
                    MyApprovedCount = await _db.WelfareApprovals
                        .CountAsync(a => a.ApproverLevel == "HRManager"
