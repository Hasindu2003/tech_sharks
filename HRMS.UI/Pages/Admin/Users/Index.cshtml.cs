...
namespace HRMS.UI.Pages.Admin.Users
{
    ...
    public class IndexModel : PageModel
    {
        ...
        {
            AllRoles = new[] { "Admin", "HR Manager", "HR Officer", "Area Manager", "Branch Manager", "Department Head", "Welfare Manager" };
            ...
            foreach (var user in users)
            {
                ...
                bool isDutyAccount = roles.Any(r => dutyRoleSet.Contains(r))
                    ...
                    || string.Equals(user.UserName, "head.welfare", StringComparison.OrdinalIgnoreCase)
                    || (user.UserName != null && (
                        ...
                        user.UserName.StartsWith("welfare", StringComparison.OrdinalIgnoreCase) ||
                        user.UserName.StartsWith("head.", StringComparison.OrdinalIgnoreCase)));
