...
namespace HRMS.UI.Pages.Employee.Maternity
{
    ...
    public class StatusModel : PageModel
    {
        ...
        public StatusModel(ApplicationDbContext context, IMaternityLeaveService maternityService, UserManager<ApplicationUser> userManager, INotificationService notificationService)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnPostCancelAsync(int leaveId)
        {
            ...
            var leave = await _context.Leaves.Include(l => l.MaternityLeave).FirstOrDefaultAsync(l => l.Id == leaveId && l.EmployeeId == employee.Id);
                ...
                try
                {
                    ...
                    foreach (var email in managerEmails)
                    {
                        ...
                        await _notificationService.CreateNotificationAsync(
                            email,
                            "Maternity Leave Request Cancelled",
                            $"{employee.FullName} has cancelled their maternity leave request from {leave.StartDate:MMM dd, yyyy} to {leave.EndDate:MMM dd, yyyy}.",
