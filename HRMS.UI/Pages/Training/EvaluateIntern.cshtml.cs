...
namespace HRMS.UI.Pages.Training
{
    public class EmployeeDetailsDto
    {
        ...
        public int InternPeriodMonths { get; set; } = 6;
    }
    ...
    public class EvaluateInternModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(int id)
        {
            ...
            {
                cmd.CommandText = @"SELECT e.Id, e.FullName, d.Name, e.InternPeriodMonths 
                                    FROM Employees e 
                ...
                using (var reader = await cmd.ExecuteReaderAsync())
                {
                    ...
                    {
                        int internPeriod = 6;
                        if (!reader.IsDBNull(3) && int.TryParse(reader[3].ToString(), out int pVal) && pVal > 0)
                        {
                            internPeriod = pVal;
                        }
                        ...
                        Intern = new EmployeeDetailsDto
                        {
                            ...
                            InternPeriodMonths = internPeriod
                        };
