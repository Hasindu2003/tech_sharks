...
namespace HRMS.UI.Services.Impl
{
    public class OverseasLeaveService : IOverseasLeaveService
    {
        ...
        public async Task<Leave> SubmitOverseasLeaveAsync(Leave leave, OverseasLeave overseasDetails)
        {
            ...
            overseasDetails.VerificationStatus = "New";
            ...
            try
            {
                ...
                foreach (var email in managerEmails)
                {
                    ...
                    await _notificationService.CreateNotificationAsync(
                        email,
                        "New Overseas Leave Request",
                        $"{employee.FullName} has requested Overseas Leave to {overseasDetails.Country} from {leave.StartDate:MMM dd, yyyy} to {leave.EndDate:MMM dd, yyyy}.",
